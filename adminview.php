                                ...
                                <div class="modal-body">
                                    <form data-action="report">
                                        <div class="input mb-5">
                                            ...
                                            <div style="margin:auto;" class="input-group p-2">
                                            ...
                                            <span style="margin-left:20px;" class="fw-bold fs-4">Student Filter</span>
                                            <div style="margin:auto;" class="input-group p-2">
                                                <select class="form-select ms-2" name="vacbrand[0]" autocomplete="off">
                                                    <option value="" hidden>Vaccine Brand</option>
                                                    <?php
                                                    foreach ($brand as $data) {
                                                    ?>
                                                        <option value="<?php echo $data['brand'] ?>"><?php echo $data['brand'] ?></option>
                                            ...
                                            <span style="margin-left:20px;" class="fw-bold fs-4">Faculty Filter</span>
                                            <div style="margin:auto;" class="input-group p-2">
                                        ...
                                        <div>
                                            <button type="submit" class="btn" style="color:white;background-color:rgb(232, 177, 62); margin-left:30%; width:200px;">Download Report <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-cloud-arrow-down" viewBox="0 0 16 16">
