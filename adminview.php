                    ...
                    <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0" style="background-color:#022e43;font-size:20px;">
                        ...
                        <div class="d-flex flex-column align-items-center align-items-sm-center px-3 pt-1 min-vh-100">
                            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="tableTab">
                                ...
                                <li class="nav-item ">
                                    <a href="login.html" class="logout nav-link" style="color:rgb(232, 177, 62);"><i class="bi bi-box-arrow-left"></i>&nbsp;&nbsp;Logout</a>
                                </li>
                            </ul>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div>
                                        ...
                                        <nav class="navbar justify-content-center">
                                            <ul class="nav">
                                                <li>
                                                    <a href="login.html" class="btn btn-success" style="color:white; width:200px;">Download Report <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-cloud-arrow-down" viewBox="0 0 16 16">
