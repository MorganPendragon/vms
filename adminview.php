                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form data-action="report">
                                        ...
                                        <div>
                                            <button type="submit" class="btn btn-success" style="color:white; width:200px;">Download Report <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-cloud-arrow-down" viewBox="0 0 16 16">
